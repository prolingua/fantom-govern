...
contract(
  ...
  async ([
    ...
    it('checking SlashingRefundProposal naming scheme', async () => {
      ...
      const proposal0 = await SlashingRefundProposal.new(
        0,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal1 = await SlashingRefundProposal.new(
        1,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal5 = await SlashingRefundProposal.new(
        5,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal9 = await SlashingRefundProposal.new(
        9,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal10 = await SlashingRefundProposal.new(
        10,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal21 = await SlashingRefundProposal.new(
        21,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal99 = await SlashingRefundProposal.new(
        99,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal100 = await SlashingRefundProposal.new(
        100,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      const proposal999 = await SlashingRefundProposal.new(
        999,
        'description',
        ratio('0.5'),
        ratio('0.8'),
      ...
      expect(await proposal0.name()).to.equal(
        'Refund for Slashed Validator #0'
      );
      expect(await proposal1.name()).to.equal(
        'Refund for Slashed Validator #1'
      );
      expect(await proposal5.name()).to.equal(
        'Refund for Slashed Validator #5'
      );
      expect(await proposal9.name()).to.equal(
        'Refund for Slashed Validator #9'
      );
      expect(await proposal10.name()).to.equal(
        'Refund for Slashed Validator #10'
      );
      expect(await proposal21.name()).to.equal(
        'Refund for Slashed Validator #21'
      );
      expect(await proposal99.name()).to.equal(
        'Refund for Slashed Validator #99'
      );
      expect(await proposal100.name()).to.equal(
        'Refund for Slashed Validator #100'
      );
      expect(await proposal999.name()).to.equal(
        'Refund for Slashed Validator #999'
      );
    });
  }
);
